...
form Directories
	...
	sentence Textgrid_directory /Users/Laura/Desktop/test-man
	#sentence Textgrid_directory /home2/lpanfili/dissertation/Mandarin/Mandarin_Praat/
...
# set all default arguments for functions (procedure at bottom of script)
   call set_parameters
	...
	for phone_interval to phone_intervals
		...
		# Only handle non-blank vowels
		if vowel_label$ <> "m" and vowel_label$ <> ""
