...
# Initialize lists that will later contain all the p, r, f, acc
p_all = []
r_all = []
f_all = []
acc_all = []
...
#features = ['H1A1c_mean','H1A1c_means001','jitter_loc_abs_2']
# 25 best f-score features
#features = ['H1A1c_means001', 'ms_from_utt_end', 'H1A2c_means003', 'sF1_means002', 'H1A2c_means002', 'CPP_means003',
#            'CPP_means002', 'CPP_mean', 'H1H2c_means001', 'shrF0_mean', 'shrF0_means001', 'H1H2c_means002',
#            'H1H2c_mean', 'strF0_means001', 'H1H2c_means003', 'shrF0_means003', 'shrF0_means002', 'strF0_mean',
#            'strF0_means002', 'strF0_means003', 'VoPT', 'sF0_means001', 'sF0_means003', 'sF0_mean', 'sF0_means002']
features = ['sF0_means002', 'sF0_mean']
...
# DOES THIS USE THE MEAN OF THE CLASS OR THE OVERALL MEAN?
def fillNaOrZero(x):
...
def runClass(x, y):
    ...
    p, r, f, s = precision_recall_fscore_support(y_test_all, y_pred_all, average = 'weighted')
    p = round((p * 100),3)
    p_all.append(p)
    r = round((r * 100),3)
    r_all.append(r)
    ...
    cr = classification_report(y_test_all, y_pred_all, digits = 6)
    print(cr)
